...
|| | 1.1   2015-08-30 - Andrea Waite   : Optimized refresh rate, rainbow pattern
|| #
||
*/
...
/* 
|| loop()
|| The main runtime heartbeat, called by Arduino once whenever the previous 
|| run of loop() completes.
*/
